    ...
    <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
        ...
        text-xl items-center px-12 h-20'>
            ...
            <ul className='hidden md:flex gap-12 z-10 cursor-pointer'>
                <li><Link to="aboutme" smooth={true} offset={50} duration={500}>About</Link></li>
                ...
                <li><Link to="certification" smooth={true} offset={50} duration={500}>Certifaction</Link></li>
            ...
            >
                <ul className='font-semibold text-4xl space-y-8 mt-24 text-center'>
                    <li><Link to="aboutme" onClick={closeNav} smooth={true} offset={50} duration={500}>About</Link></li>
                    ...
                    <li><Link to="certification" onClick={closeNav} smooth={true} offset={50} duration={500}>Certifaction</Link></li>
                </ul>
